...
original_author="igardner23"
original_name="minx0"
original_urlname="minx0"
original_description="Awesome minx0 created by igardner23" 
...
then
    ...
    echo "then run 'minx0' or 'python -m minx0'"
else
    poetry install
    echo "Applied Flask template"
    echo "Ensure you activate your env with 'poetry shell'"
    echo "then run 'minx0' or 'python -m minx0' or 'poetry run minx0'"
fi
