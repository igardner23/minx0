...
- 🎯 Entry points to execute your program using `python -m <minx0>` or `$ minx0` with basic CLI argument parsing.
...
---
# minx0 Flask Application

Awesome minx0 created by igardner23
...
```bash
git clone https://github.com/igardner23/minx0 minx0
cd minx0
make install
```
...
```bash
minx0 create-db   # run once
minx0 populate-db  # run once (optional)
minx0 add-user -u admin -p 1234  # ads a user
minx0 run
```
